...
const ProfessionalLoginModal: React.FC<ProfessionalLoginModalProps> = ({ isOpen, onClose, onSwitchToRegister }) => {
  ...
  console.log('ProfessionalLoginModal is rendering!', { isOpen, username, password });
...
export default ProfessionalLoginModal;
